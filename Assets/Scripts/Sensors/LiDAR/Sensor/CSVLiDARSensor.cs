...
namespace RobotSensors
{
    class CSVLiDARSensor : LiDARSensor
    {
        ...
        {
            base.points = new NativeArray<Vector3>(_scanPattern.size/_scanSeparation, Allocator.Persistent);
        ...
        protected override void UpdateSensor()
        {
            ...
            base._handle = _job.Schedule(_scanPattern.size/_scanSeparation, 1);
        ...
        {
            return (uint)(_scanPattern.size/_scanSeparation);
        }
